...
// MNAV Alert types
export interface MnavThresholdAlert {
	id: string;
	user_id: string;
	company_id: string;
...
export interface MnavNotification {
	id: string;
	alert_id: string;
	user_id: string;
	company_id: string;
...
export interface CreateMnavAlertRequest {
	company_id: string;
	threshold_value: number;
	alert_type: "below" | "above";
}

export interface UpdateMnavAlertRequest {
	threshold_value?: number;
	alert_type?: "below" | "above";
	is_active?: boolean;
}

export interface MnavAlertResponse {
...
// MNAV Monitor types
export interface MnavMonitorResult {
	company_id: string;
	current_mnav: number;
...
export interface MnavMonitorCheckResponse {
	success: boolean;
	message: string;
	results: MnavMonitorResult[];
}
...
export interface TestNotificationResponse {
	success: boolean;
	message: string;
	deliveries: TestNotificationDelivery[];
}
...
export interface NotificationProvidersResponse {
	success: boolean;
...
// External email service types
export interface TriggeredAlertForEmail {
	alert_id: string;
	user_email: string;
	company_ticker: string;
	company_name: string;
...
export interface CronCheckForEmailResponse {
	success: boolean;
	message: string;
	triggered_alerts: TriggeredAlertForEmail[];
